...
## Using population and clinical data to advance suicide prevention.

**CV:** [Download CV (PDF)](assets/cv/Philippe_Mortier_CV.pdf){download="Philippe_Mortier_CV.pdf"}  
...
I am a psychiatrist and principal investigator at the [Hospital del Mar Research Institute](https://researchmar.net/) in Barcelona, Spain. My research lies at the intersection of clinical epidemiology and translational psychiatry, with the overarching goal of improving the prevention and care of suicidal thoughts and behaviours.
...
::: {.cards}
::: {.card}
### The Burden of Self-Harm and Suicide
Using linked registry data to quantify the individual and population burden of self-harm and suicide.
:::

::: {.card}
### Suicidal Thoughts and Behaviours in Students
Using international survey data to study the prevalence and predictors of suicidal thoughts and behaviours among university students.
:::

::: {.card}
### Suicidal Ideation in Daily Life
Using ecological momentary assessment to investigate how affect and context relate to changes in suicidal ideation in real time.
:::

::: {.card}
### Clinical Decision Support After Self-Harm
Developing and evaluating tools to improve risk detection and support care for people presenting with self-harm.
:::
:::
:::
